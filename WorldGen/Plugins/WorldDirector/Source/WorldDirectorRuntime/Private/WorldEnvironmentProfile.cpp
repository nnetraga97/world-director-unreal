...
UWorldEnvironmentProfile::UWorldEnvironmentProfile()
{
	...
	DressingAssets = {
		...
		{TEXT("Dressing.Rock"),
			...
			0.85f, 0.68f, 1.75f},
		{TEXT("Dressing.Rock"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/natural/SM_PROP_stone_02.SM_PROP_stone_02")),
			0.9f, 0.7f, 1.7f},
		{TEXT("Dressing.Rock"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/natural/SM_PROP_stone_03.SM_PROP_stone_03")),
			1.0f, 0.72f, 1.85f},
		...
		{TEXT("Dressing.Deadwood"),
			...
			0.6f, 0.82f, 1.25f},
		{TEXT("Dressing.Deadwood"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/natural/SM_PROP_treetrunk_02.SM_PROP_treetrunk_02")),
			0.5f, 0.8f, 1.22f},
		{TEXT("Dressing.Deadwood"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/natural/SM_PROP_treetrunk_03.SM_PROP_treetrunk_03")),
			0.4f, 0.78f, 1.2f},
		{TEXT("Dressing.Deadwood"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/natural/SM_PROP_treetrunk_04.SM_PROP_treetrunk_04")),
			0.35f, 0.78f, 1.18f},
		...
		{TEXT("Dressing.Roadside"),
			...
			1.0f, 0.92f, 1.08f},
		{TEXT("Dressing.Roadside"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/light/SM_PROP_streetlamp_v01_02.SM_PROP_streetlamp_v01_02")),
			0.55f, 0.92f, 1.08f},
		{TEXT("Dressing.Roadside"),
			FSoftObjectPath(TEXT("/Game/Fantastic_Village_Pack/meshes/props/light/SM_PROP_streetlamp_v02_03.SM_PROP_streetlamp_v02_03")),
			0.45f, 0.92f, 1.08f},
